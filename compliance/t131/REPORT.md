...
> 2026-07-24 后续架构变更：官方官网、公共文档快照和公开文案门禁已迁移到独立仓库 `IvyYang1999/swob-website`。本报告中的 `site/` 路径、Pages 流程、资产数量和 `check:public-copy` 描述是下述审计基线的历史证据，不再描述当前主应用仓库结构。

- 审计单：t131（t140 发布候选增量复核）
- 审计日期：2026-07-23
- 产品基线：`7a7eab3059d274c3d7959cdca92889eb1888ab3a`
...
- `history-deletions.json`：产品基线中已删除源码/视觉资产及其在历史发布标签中的存在性。
