...
// Set theme and color scheme before first render to prevent flash
...
const savedScheme = localStorage.getItem('csm:colorScheme')
document.documentElement.dataset.colorScheme =
  savedScheme === 'paper' || savedScheme === 'nord' ? savedScheme : 'default'
