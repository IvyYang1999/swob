...
export function createBuiltinToolRegistryV2(): ToolRegistryV2 {
  ...
  const aliases: RawToolAliasV2[] = [
    ...
    { providerId: 'swob/cursor', rawName: 'Read', semanticToolId: 'filesystem.read' },
    { providerId: 'swob/cursor', rawName: 'Write', semanticToolId: 'filesystem.write' },
    { providerId: 'swob/cursor', rawName: 'Bash', semanticToolId: 'shell.execute' },
    { providerId: 'swob/opencode', rawName: 'Read', semanticToolId: 'filesystem.read' },
    { providerId: 'swob/opencode', rawName: 'Write', semanticToolId: 'filesystem.write' },
    { providerId: 'swob/opencode', rawName: 'Bash', semanticToolId: 'shell.execute' },
    { providerId: 'swob/zcode', rawName: 'Read', semanticToolId: 'filesystem.read' },
    { providerId: 'swob/zcode', rawName: 'Write', semanticToolId: 'filesystem.write' },
    { providerId: 'swob/zcode', rawName: 'Bash', semanticToolId: 'shell.execute' },
    { providerId: 'swob/cc-mirror', rawName: 'Read', semanticToolId: 'filesystem.read' },
    { providerId: 'swob/cc-mirror', rawName: 'Write', semanticToolId: 'filesystem.write' },
    { providerId: 'swob/cc-mirror', rawName: 'Bash', semanticToolId: 'shell.execute' },
    { providerId: 'swob/cc-mirror', rawName: 'AskUserQuestion', semanticToolId: 'interaction.question' },
