...
- ⚠️ **未签名/未公证**：安装需 `xattr -cr /Applications/Swob.app` 绕 Gatekeeper（签名接入进行中，今日可能完成）。README 已有说明，落地页下载区也要写。
- ⚠️ **仅 macOS**。
...
## 关键链接
- 仓库：github.com/IvyYang1999/swob（public，AGPL-3.0）
- Releases：github.com/IvyYang1999/swob/releases（v1.2.0 dmg）
